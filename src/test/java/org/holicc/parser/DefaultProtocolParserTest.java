...
class DefaultProtocolParserTest {
    ...
    void testParseSimpleString(String req) throws ProtocolParseException {
        ...
        RedisValueType<String> parse = parser.parse(req.getBytes(StandardCharsets.UTF_8), 0);
    ...
    void testParseInteger(String req) throws ProtocolParseException {
        ...
        RedisValueType<Integer> parse = parser.parse(req.getBytes(StandardCharsets.UTF_8), 0);
    ...
    void testParseError(String req) throws ProtocolParseException {
        ...
        RedisValueType<RedisError> parse = parser.parse(req.getBytes(StandardCharsets.UTF_8), 0);
    ...
    void testParseBulkString(String req) throws ProtocolParseException {
        ...
        RedisValueType<byte[]> parse = parser.parse(req.getBytes(StandardCharsets.UTF_8), 0);
    ...
    void testParseArray(String req) throws ProtocolParseException {
        ...
        RedisValueType<List<RedisValueType>> parse = parser.parse(req.getBytes(StandardCharsets.UTF_8), 0);
        List<RedisValueType> value = parse.getValue();
